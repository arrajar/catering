  ...
  return (
    <section className="min-h-screen bg-black text-gold py-16 px-4 font-serif">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <img src="/images/catering1.jpg" alt="Catering Service" className="mx-auto rounded-lg mb-8 border-4 gold-border shadow-lg max-h-64 object-cover" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
          <div className="bg-rich-black bg-opacity-80 p-6 rounded-lg gold-border border">
            ...
            <img src="/images/food1.jpg" alt="Wedding Food" className="rounded-lg mt-4 border-2 gold-border mx-auto max-h-32 object-cover" />
          </div>
          <div className="bg-rich-black bg-opacity-80 p-6 rounded-lg gold-border border">
            ...
            <img src="/images/food2.jpg" alt="Corporate Food" className="rounded-lg mt-4 border-2 gold-border mx-auto max-h-32 object-cover" />
          </div>
          <div className="bg-rich-black bg-opacity-80 p-6 rounded-lg gold-border border">
            ...
            <img src="/images/event1.jpg" alt="Birthday Event" className="rounded-lg mt-4 border-2 gold-border mx-auto max-h-32 object-cover" />
          </div>
          <div className="bg-rich-black bg-opacity-80 p-6 rounded-lg gold-border border">
            ...
            <img src="/images/catering1.jpg" alt="Outdoor Catering" className="rounded-lg mt-4 border-2 gold-border mx-auto max-h-32 object-cover" />
          </div>
        </div>
      </div>
    </section>
